...
var optionsBar, chartBar, options, chart, chartCandlestickCategoryColors = getChartColorsArray("category_candlestick"), chartCandlestickLineColors = (chartCandlestickCategoryColors && (options = {
    series: [{
        name: "candle",
        data: [{
            x: new Date(15387786e5),
...
(chart = new ApexCharts(document.querySelector("#category_candlestick"),options)).render()),
